...
<head>
    ...
    <style>
        ...
        .contact-hero {
            text-align: center;
            padding: 45px 20px;
            background-color: #fff4f6; /* Solid soft pink background */
            border-radius: 16px;
            margin-bottom: 40px;
        ...
        .team-card:nth-child(even) .member-role {
            background-color: #eef5fc; /* Solid background */
...
<body>
    ...
    <div class="contact-hero">
        ...
        <p>Mọi ý kiến đóng góp, phản hồi về tính năng hay giao diện của Website Mẹ & Bé, vui lòng gửi cho chúng tôi qua biểu mẫu bên dưới.</p>
    </div>
    ...
    <div class="contact-main-layout">
        ...
        <div class="contact-form-card">
            <h3>
                <i class="fa-solid fa-paper-plane" style="color: var(--primary-color); margin-right: 8px;"></i> Gửi góp ý
            </h3>
            <form id="contactForm" onsubmit="handleContactSubmit(event)">
                <div class="form-group">
                    <label style="font-weight: 600; display: block; margin-bottom: 8px; font-size: 15px;">Họ tên của bạn</label>
                    <input type="text" class="form-control" placeholder="Nhập họ và tên..." required>
                </div>
                <div class="form-group">
                    <label style="font-weight: 600; display: block; margin-bottom: 8px; font-size: 15px;">Địa chỉ Email</label>
                    <input type="email" class="form-control" placeholder="Nhập email của bạn..." required>
                </div>
                <div class="form-group">
                    <label style="font-weight: 600; display: block; margin-bottom: 8px; font-size: 15px;">Tiêu đề góp ý</label>
                    <input type="text" class="form-control" placeholder="Ví dụ: Lỗi giao diện, Góp ý..." required>
                </div>
                <div class="form-group">
                    <label style="font-weight: 600; display: block; margin-bottom: 8px; font-size: 15px;">Nội dung phản hồi</label>
                    <textarea class="form-control" rows="5" placeholder="Mô tả chi tiết nội dung góp ý..." style="resize: none;" required></textarea>
                </div>
        ...
        <div class="team-column-container">
            <h3>
                <i class="fa-solid fa-users" style="color: var(--secondary-color); margin-right: 8px;"></i> Thành viên nhóm
            </h3>
            <div class="team-list">
